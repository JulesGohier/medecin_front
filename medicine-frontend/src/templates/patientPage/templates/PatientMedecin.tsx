...
import {MedecinCard} from "@/templates/patientPage/components/MedecinCard.tsx";
import {authenticateMedecin, fetchAllMedecins} from "@/templates/patientPage/actions/patient-action.ts";

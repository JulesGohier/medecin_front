...
import {
  annulerAppointement,
  deleteAppointement,
} from "@/templates/medecinPage/actions/medecin-action.ts";
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="my-2 flex items-center">
          ...
          <p>
            Cliquer sur le bouton pour confirmer la suppression, sinon annuler
          </p>
        </div>
        ...
        <DialogFooter>
          <Button
            type="submit"
            className={
              "bg-red-800 hover:bg-red-700 w-full flex items-center gap-2"
            }
            onClick={() => {

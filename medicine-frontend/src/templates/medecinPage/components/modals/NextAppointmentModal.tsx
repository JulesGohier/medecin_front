...
import {AppointmentModalProps} from "@/templates/medecinPage/components/modals/AppointmentModal.tsx";
import {formatDate, formatPhoneNumber} from "@/templates/medecinPage/format/format.ts";
